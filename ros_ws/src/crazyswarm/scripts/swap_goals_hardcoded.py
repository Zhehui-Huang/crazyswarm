...
if __name__ == '__main__':
    ...
    allcfs.crazyfliesById[3].goTo(goal=init_pos[47], yaw=0, duration=4.0)
    allcfs.crazyfliesById[47].goTo(goal=init_pos[3], yaw=0, duration=4.0)

    allcfs.crazyfliesById[33].goTo(goal=init_pos[28], yaw=0, duration=4.0)
    allcfs.crazyfliesById[28].goTo(goal=init_pos[33], yaw=0, duration=4.0)
